...
\begin{itemize}
\setlength{\itemindent}{30pt}
\item[\itt{-g2taxonomy}] \itt{-r2taxonomy} \itt{-s2taxonomy} Use to specify mapping files to map reference sequences to taxonomic identifiers (NCBI taxon integer ids).
...
OPTIONS
 ...
 Classification:
	...
	-r2taxonomy, --ref2taxonomy [string]   RefSeq-to-Taxonomy mapping file. 
