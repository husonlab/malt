...
public class ReferenceSeedsLoop {
     ...
     */
    public static void
    run(final ExecutorService threadPool, final int chunk, final int numberOfChunks, final int numberOfJobs, final int numberOfThreads,
        final IReferenceStore refStore, final SeedShape2 seedShape, final SeedStore[] seedStores) {
